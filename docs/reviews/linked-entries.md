...
Implemented on `feature/lexicoff-linked-entries` in an isolated worktree, initially from `eeed86d` and merged with main at `6e0e544` before PR review. The original checkout was left untouched. The local preview is [http://127.0.0.1:5177](http://127.0.0.1:5177).

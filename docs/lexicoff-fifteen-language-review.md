...
Full raw English Wiktionary extract, September 2 dump / September 9 extraction. Compressed extract SHA256: `42e0bfe1669513cb89bd0a12f2e85d1a8f4ebedc70c65ec88c9509d0f5d392f9`. New languages use the immutable snapshot `2026-09-15T074500Z`; existing source pins and language manifest entries are preserved.
...
- Add a native/English-name language filter, interleave native names by pronunciation, display readings, and prevent IME confirmation Enter from opening a result.

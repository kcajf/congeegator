...
New downloads remain compressed in OPFS until import. The application validates the expanded SQLite size and streams decompression with bounded output. Unfinished downloads are listed for explicit retry rather than imported automatically at startup.
